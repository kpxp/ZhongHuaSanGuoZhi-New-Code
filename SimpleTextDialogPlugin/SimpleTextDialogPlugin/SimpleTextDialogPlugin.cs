namespace SimpleTextDialogPlugin
{
    ...
    public class SimpleTextDialogPlugin : GameObject, ISimpleTextDialog, IBasePlugin, IPluginXML, IPluginGraphics
    {
        ...
        private const string DataPath = @"GameComponents\SimpleTextDialog\Data\";
        private string description = "简单文本对话框";
        private GraphicsDevice graphicsDevice;
        private const string Path = @"GameComponents\SimpleTextDialog\";
        ...
        public void LoadDataFromXMLDocument(string filename)
        {
            ...
            this.simpleTextDialog.BackgroundTexture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\SimpleTextDialog\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.simpleTextDialog.RichText.Builder.SetFreeTextBuilder(this.graphicsDevice, font);
            this.simpleTextDialog.RichText.DefaultColor = color;
            node = nextSibling.ChildNodes.Item(2);
            this.simpleTextDialog.FirstPageButtonTexture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\SimpleTextDialog\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            this.simpleTextDialog.FirstPageButtonSelectedTexture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\SimpleTextDialog\Data\" + node.Attributes.GetNamedItem("Selected").Value);
            this.simpleTextDialog.FirstPageButtonDisabledTexture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\SimpleTextDialog\Data\" + node.Attributes.GetNamedItem("Disabled").Value);
            ...
            this.simpleTextDialog.TextTree.LoadFromXmlFile(@"GameComponents\SimpleTextDialog\Data\SimpleTextTree.xml");
        }
        ...
        public void SetGraphicsDevice(GraphicsDevice device)
        {
            ...
            this.LoadDataFromXMLDocument(@"GameComponents\SimpleTextDialog\SimpleTextDialogData.xml");
        }
