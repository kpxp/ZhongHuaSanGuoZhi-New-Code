namespace TabListPlugin
{
    ...
    public class TabListPlugin : GameObject, ITabList, IBasePlugin, IPluginXML, IPluginGraphics
    {
        ...
        private const string DataPath = @"GameComponents\TabList\Data\";
        private string description = "可选择类别的详细列表";
        private const string Path = @"GameComponents\TabList\";
        ...
        public void LoadDataFromXMLDocument(string filename)
        {
            ...
            this.tabList.tabbuttonTexture = Texture2D.FromFile(this.tabList.graphicsDevice, @"GameComponents\TabList\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            this.tabList.tabbuttonselectedTexture = Texture2D.FromFile(this.tabList.graphicsDevice, @"GameComponents\TabList\Data\" + node.Attributes.GetNamedItem("SelectedFileName").Value);
            node = nextSibling.ChildNodes.Item(1);
            this.tabList.columnheaderHeight = int.Parse(node.Attributes.GetNamedItem("Height").Value);
            this.tabList.columnheaderTexture = Texture2D.FromFile(this.tabList.graphicsDevice, @"GameComponents\TabList\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.tabList.columnspliterTexture = Texture2D.FromFile(this.tabList.graphicsDevice, @"GameComponents\TabList\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            node = nextSibling.ChildNodes.Item(3);
            this.tabList.scrollbuttonWidth = int.Parse(node.Attributes.GetNamedItem("Width").Value);
            this.tabList.scrollbuttonTexture = Texture2D.FromFile(this.tabList.graphicsDevice, @"GameComponents\TabList\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            node = nextSibling.ChildNodes.Item(4);
            this.tabList.scrolltrackWidth = int.Parse(node.Attributes.GetNamedItem("Width").Value);
            this.tabList.scrolltrackTexture = Texture2D.FromFile(this.tabList.graphicsDevice, @"GameComponents\TabList\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            node = nextSibling.ChildNodes.Item(5);
            this.tabList.leftArrowTexture = Texture2D.FromFile(this.tabList.graphicsDevice, @"GameComponents\TabList\Data\" + node.Attributes.GetNamedItem("LeftFileName").Value);
            this.tabList.rightArrowTexture = Texture2D.FromFile(this.tabList.graphicsDevice, @"GameComponents\TabList\Data\" + node.Attributes.GetNamedItem("RightFileName").Value);
            node = nextSibling.ChildNodes.Item(6);
            this.tabList.focusTrackTexture = Texture2D.FromFile(this.tabList.graphicsDevice, @"GameComponents\TabList\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.tabList.checkboxTexture = Texture2D.FromFile(this.tabList.graphicsDevice, @"GameComponents\TabList\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            this.tabList.checkboxSelectedTexture = Texture2D.FromFile(this.tabList.graphicsDevice, @"GameComponents\TabList\Data\" + node.Attributes.GetNamedItem("SelectedFileName").Value);
            this.tabList.roundcheckboxTexture = Texture2D.FromFile(this.tabList.graphicsDevice, @"GameComponents\TabList\Data\" + node.Attributes.GetNamedItem("RoundFileName").Value);
            this.tabList.roundcheckboxSelectedTexture = Texture2D.FromFile(this.tabList.graphicsDevice, @"GameComponents\TabList\Data\" + node.Attributes.GetNamedItem("RoundSelectedFileName").Value);
            ...
            this.tabList.SelectSoundFile = @"GameComponents\TabList\Data\" + node.Attributes.GetNamedItem("Select").Value;
        ...
        public void SetGraphicsDevice(GraphicsDevice device)
        {
            ...
            this.LoadDataFromXMLDocument(@"GameComponents\TabList\TabListData.xml");
        }
