namespace MapViewSelectorPlugin
{
    ...
    public class MapViewSelectorPlugin : GameObject, IMapViewSelector, IBasePlugin, IPluginXML, IPluginGraphics, IScreenDisableRects
    {
        ...
        private const string DataPath = @"GameComponents\MapViewSelector\Data\";
        private string description = "地图视角选择器";
        private GraphicsDevice graphicsDevice;
        private MapViewSelector mapViewSelector = new MapViewSelector();
        private const string Path = @"GameComponents\MapViewSelector\";
        ...
        public void LoadDataFromXMLDocument(string filename)
        {
            ...
            this.mapViewSelector.TitleTexture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\MapViewSelector\Data\" + node2.Attributes.GetNamedItem("FileName").Value);
            ...
            this.mapViewSelector.ButtonTexture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\MapViewSelector\Data\" + node2.Attributes.GetNamedItem("FileName").Value);
            this.mapViewSelector.ButtonSelectedTexture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\MapViewSelector\Data\" + node2.Attributes.GetNamedItem("Selected").Value);
            ...
            this.mapViewSelector.ItemInListTexture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\MapViewSelector\Data\" + node2.Attributes.GetNamedItem("InList").Value);
            this.mapViewSelector.ItemSelectedTexture = Texture2D.FromFile(this.graphicsDevice, @"GameComponents\MapViewSelector\Data\" + node2.Attributes.GetNamedItem("Selected").Value);
        }
        ...
        public void SetGraphicsDevice(GraphicsDevice device)
        {
            ...
            this.LoadDataFromXMLDocument(@"GameComponents\MapViewSelector\MapViewSelectorData.xml");
        }
