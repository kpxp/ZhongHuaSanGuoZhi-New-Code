...
namespace GameFormFramePlugin
{
    public class GameFramePlugin : GameObject, IGameFrame, IBasePlugin, IPluginXML, IPluginGraphics
    {
        ...
        public void SetFrameyoucelanContent(object content, Microsoft.Xna.Framework.Point viewportSize)
        {
            if (content is FrameContent)
            {
                this.gameFrame.SetFrameyoucelanContent(content as FrameContent, viewportSize);
            }
        }
        ...
        public bool shiyoucelan
        {
            get
            {
                return this.gameFrame.shiyoucelan;
            }
            set
            {
                this.gameFrame.shiyoucelan = value;
            }
        }*/
